import{d,u as _,a as u,c as m,b as h,r as p,o as a,e as n,f as t,t as s,g as l,F as f,h as g,n as v,i as x,j as b,k as y,l as k,m as N,_ as w}from"./index-7gOEwIeT.js";import{N as P}from"./NoteDisplay-IuzTTUUX.js";const V={class:"m-4"},D={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},S={class:"opacity-50"},T={class:"text-lg"},j={class:"font-bold flex gap-2"},B={class:"opacity-50"},H=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},C=d({__name:"PresenterPrint",setup(F){_(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
